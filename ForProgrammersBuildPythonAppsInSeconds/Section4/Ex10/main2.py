import sys
import csv
from PyQt6.QtWidgets import QApplication, QMainWindow, QLabel, QDateEdit, QPushButton, QVBoxLayout, QWidget, QComboBox
...
class TemperatureGraphApp(QMainWindow):
    def __init__(self):
        ...
        layout.addWidget(self.graph_type_label)
    ...
    def generate_graph(self):
        ...
        if graph_type == "Line Graph":
            ...
            ax.bar(filtered_dates, filtered_temperatures)
